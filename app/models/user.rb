class User < ApplicationRecord
  ...
  has_many :active_relationships, class_name: Settings.defaults.relationship_name,
foreign_key: :follower_id, dependent: :destroy
  has_many :passive_relationships, class_name: Settings.defaults.relationship_name,
